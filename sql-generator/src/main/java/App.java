...
public class App {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/forum?useUnicode=true&serverTimezone=Asia/Shanghai&characterEncoding=utf8&autoReconnect=true&allowMultiQueries=true");
        autoGenerator.setDataSource(dataSourceConfig);
        GlobalConfig globalConfig = new GlobalConfig();
        globalConfig.setOpen(true); // 代码生成后打开目录
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/src");
        globalConfig.setAuthor("ellery");
...
//        globalConfig.setSwagger2(true);// 开启Swaggers模式
        ...
        packageConfig.setParent("com.xxx.forum");
